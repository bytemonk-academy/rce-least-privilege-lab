# Lab guide: the full walkthrough
...
![Architecture: candidate and recruiter use the website, which calls the Spring Boot API; the API saves candidate data in PostgreSQL and uploads and retrieves resumes in an S3 bucket](architecture.png)
